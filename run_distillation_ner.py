...
def parse_args():
    parser = argparse.ArgumentParser(description="Distil a transformers model on a named entity recognition task.")
    parser.add_argument(
        "--model_type",
        type=str,
        required=True,
...
def main():
    ...
    if args.do_train:
        ...
        #assert t_config.num_hidden_layers % layer_or_sparsity_val == 0
        ...
        if not os.path.isdir(args.student_model_path):
